#!/bin/bash
# kernel-arm64-legacy-modules-generic — build all modules, keep the
...
echo "Building generic modules (arm64-legacy) for kernel $KVER..."
...
# Same SoC whitelist as kernel-arm64-legacy-modules-soc. We keep the
# COMPLEMENT here.
SOC_DIRS=(
  drivers/gpu
